...
describe('giftRegistryHelpers', function () {
    ...
    describe('edit', function () {
        ...
        beforeEach(function () {
            setNameSpy.reset();
            setEventCitySpy.reset();
            setEventDateSpy.reset();
            setEventCountrySpy.reset();
            setEventStateSpy.reset();

            setEmailSpy.reset();
            setFirstNameSpy.reset();
            setLastNameSpy.reset();
            setRoleSpy.reset();

            getCoRegistrantStub.reset();

            setAddress1Spy.reset();
            setAddress2Spy.reset();
            setCitySpy.reset();
            setStateCodeSpy.reset();
            setCountryCodeSpy.reset();
            setPostalCodeSpy.reset();
            setPhoneSpy.reset();
            setIDSpy.reset();

            setShippingAddressStub.reset();
            setPostEventShippingAddressStub.reset();
            getAddressStub.reset();
            createAddressStub.reset();
        });
