    ...
    it('should show error messages for event info submission', function () {
        return request(generateCsrfToken)
            ...
            .then(function (editRegistryResponse) {
                ...
                assert.equal(response.fields.dwfrm_giftRegistry_giftRegistryEvent_event_eventName, 'This field is required.');
                assert.equal(response.fields.dwfrm_giftRegistry_giftRegistryEvent_event_eventDate, 'This field is required.');
                assert.equal(response.fields.dwfrm_giftRegistry_giftRegistryEvent_event_eventState_stateCode, 'Please select a State');
                assert.equal(response.fields.dwfrm_giftRegistry_giftRegistryEvent_event_eventCity, 'This field is required.');
            });
    });
